...
//    [[UIApplication sharedApplication] setStatusBarOrientation:UIInterfaceOrientationLandscapeLeft animated:NO];
	...
	[options setFormatOptionIntValue:0 forKey:@"max-delay"];
	[options setFormatOptionIntValue: 0 forKey:@"reorder_queue_size"];
//
//
//	////potential RTSP RTMP issue , sample showed it should be rtsp
//
	//[options setFormatOptionValue:@"udp" forKey:@"rtmp_transport"];
	...
	[options setCodecOptionValue:@"zerolatency"  forKey: @"tune"];
	
	NSLog(@"OPTIONS VALUES SET ++++++++++++++++++++++++++++");
...
- (void)moviePlayBackStateDidChange:(NSNotification*)notification
{
	...
	NSLog(@"PLAYBACK STATE DID CHANGE --- HEREEE>>>>>>>>>" );
